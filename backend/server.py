...
async def create_contact_message(input: ContactMessageCreate):
    ...
    try:
        ...
        logger.info(f"New contact message saved to DB from {input.email}")
    except Exception as e:
        logger.warning(f"Failed to save to MongoDB (continuing to email): {e}")
    
    logger.info(f"Processing contact message from {input.email}")
